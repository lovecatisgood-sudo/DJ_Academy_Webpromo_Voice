...
const chrome = {
  en: {
    ...
    goalHelp: "Choose the result you want first. We use it to recommend a starter flow and launch channel; it does not change your plan.",
    saveGoal: "Save goal & continue",
  ...
  th: {
    ...
    goalHelp: "เลือกผลลัพธ์ที่ต้องการก่อน ระบบจะใช้เพื่อแนะนำโฟลว์เริ่มต้นและช่องทาง โดยไม่เปลี่ยนแผนของคุณ",
    saveGoal: "บันทึกเป้าหมายแล้วไปต่อ",

...
describe("role-aware platform navigation", () => {
  it("shows every governed area to the platform owner", () => {
    expect(labels("platform_owner")).toEqual(["Overview", "Release", "Usage", "Voice", "Recovery", "Commerce", "Fulfillment", "Support"]);
  });
  ...
  it("limits navigation to each operational role", () => {
    ...
    expect(labels("platform_support")).toEqual(["Overview", "Release", "Recovery", "Fulfillment", "Support"]);
    expect(labels("platform_finance")).toEqual(["Overview", "Release", "Usage", "Commerce", "Fulfillment", "Support"]);
  });
